...
let AdminOrdersController = class AdminOrdersController {
    ...
    async retrieve(order_hashid) {
        const order = await this.ordersRepository.retrieve(order_hashid);
        return { order };
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdminOrdersController.prototype, "retrieve", null);
exports.AdminOrdersController = AdminOrdersController = __decorate([
    (0, common_1.Controller)('/admin/orders'),
    __metadata("design:paramtypes", [admin_repository_1.IAdminOrdersRepository])
