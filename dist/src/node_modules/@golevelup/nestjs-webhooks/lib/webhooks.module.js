 ...
 */
let WebhooksModule = class WebhooksModule extends (0, nestjs_modules_1.createConfigurableDynamicRootModule)(webhooks_constants_1.WEBHOOK_MODULE_PROVIDED_CONFIG_TOKEN, {
    providers: [
        {
            provide: webhooks_constants_1.WEBHOOK_MODULE_CONFIG_TOKEN,
            useFactory: (providedConfig) => {
                return Object.assign(Object.assign({}, defaultModuleOptions), providedConfig);
            },
            inject: [webhooks_constants_1.WEBHOOK_MODULE_PROVIDED_CONFIG_TOKEN],
        },
    ],
    exports: [webhooks_constants_1.WEBHOOK_MODULE_PROVIDED_CONFIG_TOKEN, webhooks_constants_1.WEBHOOK_MODULE_CONFIG_TOKEN],
}) {
};
