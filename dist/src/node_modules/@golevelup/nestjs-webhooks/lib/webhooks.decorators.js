 ...
 */
exports.InjectProvidedWebhookConfig = (0, nestjs_common_1.makeInjectableDecorator)(webhooks_constants_1.WEBHOOK_MODULE_PROVIDED_CONFIG_TOKEN);
/**
 * Injects the final Webhook Config (optional values filled in with defaults) from this module
 */
exports.InjectWebhookConfig = (0, nestjs_common_1.makeInjectableDecorator)(webhooks_constants_1.WEBHOOK_MODULE_CONFIG_TOKEN);
