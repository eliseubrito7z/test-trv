...
export declare const applyRawBodyWebhookMiddleware: (consumer: MiddlewareConsumer, rawBodyRoutes: (string | Type<any> | RouteInfo)[], jsonBodyRoutes: (string | Type<any> | RouteInfo)[]) => void;
export declare const applyRawBodyOnlyTo: (consumer: MiddlewareConsumer, ...rawBodyRoutes: (string | RouteInfo)[]) => void;
/**
 ...
 */
export declare const applyConfigurableRawBodyWebhookMiddleware: (consumer: MiddlewareConsumer, rawBodyRoutes: (string | Type<any> | RouteInfo)[], jsonBodyRoutes?: (string | Type<any> | RouteInfo)[]) => void;
